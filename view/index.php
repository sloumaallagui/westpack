...
<main class="" style="min-height:450px; ">
    <div class="row container-expand-gl mx-auto sign" style="width: 75%; padding:0; ">
        ...
        <br>
        <div class="col-12 row ok" style="background-color: white;height:360px ; padding:0; margin:40px;">
            <div class="col-4 col-xs-12 mobilerow">
                <form action="incorrect.php" style="margin:30px">
            ...
            <div id="list-option" class="col-md-4 col-xs-0 rowlist" style="background-color: #DA1E10; padding-top:100px; color:white; width: 100%; transform: translate(15%,0); height:360px;">
